...
import type { StockFilters as StockFiltersValues } from '../model/types';

type StockFiltersProps = {
  filters: StockFiltersValues;
  isLoading: boolean;
  isOpen: boolean;
  onApply: (filters: StockFiltersValues) => void;
  onClick: () => void;
  onClose: () => void;
...
export const StockFilters = ({
  ...
  const [localFilters, setLocalFilters] = useState<StockFiltersValues>(filters);
  const {
    categories,
