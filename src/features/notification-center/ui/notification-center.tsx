...
export const NotificationCenter = () => {
  ...
  if (!notifications.isAllowed) return null;
  ...
  return (
    <>
      ...
      <Drawer
        title="Уведомления"
        subTitle={`${notifications.unreadCount} непрочитанных`}
        position="right"
        width="440px"
      ...
      >
        <div className="flex h-full min-h-0 flex-col gap-4">
          <SegmentedControl
            ...
            onChange={(value) => notifications.setUnreadOnly(value === 'unread')}
            rounded
            size="m"
            variant="accent"
          />
          ...
          <div className="flex flex-wrap gap-2">
            <Button
              ...
              disabled={!notifications.unreadCount || notifications.isMarkingAllRead}
            ...
            <Button
              ...
              size="s"
              variant="outline-neutral"
              disabled={notifications.isClearingRead}
